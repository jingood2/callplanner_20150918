...
(function($) {
    ...
    function createOutboundCall() {
        var configuration = {
            'ws_servers': ['wss://192.168.100.227:7443'],
            'uri': 'sip:01089995723@192.168.100.227:5060',
            'password': '1234',
            'register': false,
...
//            'pcConfig': pcConfig,
        ...
        ua.on('connected', function(data) {
            ...
            ua.call('sip:07074145345@192.168.100.227:5060', opts);
        });
            ...
            session.on('newDTMF', function(data) {
                ...
                if(data.dtmf.tone == '0') {
                    ...
                    rpcClient.call('verto.subscribe', {
                        eventChannel: [
                        'conference.callplanner@192.168.100.227',
                        'conference-liveArray.callplanner@192.168.100.227',
                        'conference-chat.callplanner@192.168.100.227'
                        ],
                        subParams: {} 
                    });
                };
...
//            session.sendDTMF(mute_tones, opts);
            var msg = {
                eventChannel: 'conference.callplanner@192.168.100.227',
                data: {
...
//            console.log('Mute Buttion clicked, terminate session: ', e)
    ...
    var options = $.extend({
        login: null,
        passwd: null,
        socketUrl: 'ws://192.168.100.227:8081', 
        tag: null,
        localTag: null,
        videoParams: {},
        audioParams: {},
        ...
        if(e.method == 'verto.event') {
            ...
            switch(e.params.data.action) {
                ...
                case 'modify':
                    ...
                    var m_status = $.parseJSON(e.params.data.data[4]).oldStatus;
                    switch(m_status) {
                        case 'FLOOR':
    ...
    function sendChatMessage() {
        ...
        $record_button.bind('click', function(e) {
            ...
            ua.sendMessage('sip:01089995723@192.168.100.227', msg, opts);
            */
            var msg = {
                eventChannel: 'conference-chat.callplanner@192.168.100.227',
                data: {
                    'to': 'conf+callplanner@192.168.100.227',
                    ...
                    for(var i=0; i<dest_number.length; i++) {
                        ...
                        */
                        vertoSendMethod('fsapi', {
                            ...
                            'sessid': rpcSessId,
                            'cmd': 'bgapi',
                            'arg': 'conference callplanner bgdial sofia/internal/' + dest_number[i] + '@192.168.100.227 01089995723 Wonchang Shin'
                        });
                    };
                };
            });
