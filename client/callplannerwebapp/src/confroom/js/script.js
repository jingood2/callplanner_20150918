...
/*
		    o.call('login', {});
		    function(data) {
			console.log("JSON-RPC login result: ", data);	
		    },
		    function(error) {
...
*/
    ...
    function rpcMessageHandler(data) {
	//console.log("RPC message: ", data.method, data.params);
	switch(data.method) {
	    case 'verto.event':
		console.log("verto.event: ", data.params);
		break;
	    default:
