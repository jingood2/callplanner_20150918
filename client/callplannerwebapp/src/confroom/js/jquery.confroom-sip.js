...
(function($) {
    ...
    function createOutboundCall() {
        var configuration = {
            uri: 'sip:01089995723@221.146.204.182:5060',
            wsServers: ['wss://221.146.204.182:7443'],
            traceSip: true,
            password: '1234',
            register: false,
        ...
        ua.on('connected', function() {
            ...
            session = ua.invite('sip:07074145345@221.146.204.182:5060', opts);
            ...
            session.on('dtmf', function(request, dtmf) {
                ...
                if(dtmf.tone == '0') {
                    ...
                    rpcClient.call('verto.subscribe', {
                        eventChannel: [
                        'conference.callplanner@221.146.204.182',
                        'conference-liveArray.callplanner@221.146.204.182',
                        'conference-chat.callplanner@221.146.204.182'
                        ],
                        subParams: {} 
                    });
                };
    ...
    function setCbForMuteCall() {
        ...
        $mute_button.bind('click', function(e) {
            /* Mute a member by sending a pre-defined DTMF key ('0')
            ...
            */
            ...
            var msg = {
                eventChannel: 'conference.callplanner@221.146.204.182',
                data: {
            ...
            */
            ...
            var args = 'conference callplanner ';
            console.log('Mute Buttion clicked: ', e, $mute_button.text());
            if($mute_button.text() == 'Mute') {
                args = args + 'mute ' + mid;
            }
            else {
                args = args + 'unmute ' + mid;
            };
    ...
    function setCbForLockCall() {
        ...
        $lock_button.bind('click', function(e) {
            ...
            vertoSendMethod('fsapi', {
                ...
                'sessid': rpcSessId,
                'cmd': 'bgapi',
                'arg': 'conference callplanner lock' 
            });
            e.preventDefault();
        });
    };
    ...
    var options = $.extend({
        login: null,
        passwd: null,
        socketUrl: 'ws://221.146.204.182:8081', 
        tag: null,
        localTag: null,
        videoParams: {},
        audioParams: {},
    ...
    function sendChatMessage() {
        ...
        $record_button.bind('click', function(e) {
            ...
            ua.message('sip:01089995723@221.146.204.182', msg, opts);
            */
            var msg = {
                eventChannel: 'conference-chat.callplanner@221.146.204.182',
                data: {
                    'to': 'conf+callplanner@221.146.204.182',
                    ...
                    for(var i=0; i<dest_number.length; i++) {
                        ...
                        */
                        vertoSendMethod('fsapi', {
                            ...
                            'sessid': rpcSessId,
                            'cmd': 'bgapi',
                            'arg': 'conference callplanner bgdial sofia/internal/' + dest_number[i] + '@221.146.204.182 01089995723 Wonchang Shin'
                        });
                    };
                };
            });
